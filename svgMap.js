    ...
    svgMap.prototype.getTooltipContent = function (countryID) {
        ...
        if (this.options.hideFlag === false) {
            ...
            if (this.options.flagType === "image") {
                this.createElement("img", "svgMap-tooltip-flag", flagContainer).setAttribute(
                    "src",
        ...
        // Title
        this.createElement("div", "svgMap-tooltip-title", tooltipContentWrapper).innerHTML =
            this.getCountryName(countryID);
        ...
        if (!this.options.data.values[countryID]) {
            this.createElement("div", "svgMap-tooltip-no-data", tooltipContent).innerHTML =
